...
- [GitHub Repository](https://github.com/jakerood/datafun-07-ml-predictive)

In this module, we employ a type of supervised learning, simple linear regression, to train a model using all available data. 
We use the resulting model (a best-fit straight line) to make predictions.
...
- Edit and customize README.md files, which provide a quick overview of the project and instructions for running it. 
